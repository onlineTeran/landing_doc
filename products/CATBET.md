...
- [Open CatBox assets](https://www.figma.com/design/60GcNX5ozOg29YImVj1mNz/%F0%9F%90%88-Visual-Assets-CB?node-id=2853-74)
- [Brand landing reference and typography](https://www.figma.com/design/Awy5S2tjqMYp9q6y0brMB8/slotsonbet--Copy-?node-id=3442-7005)
...
|---|---|---|---|
| CAT mascot | canonical identity and blue fur | hero, promo story, mission art | generic cat/body drift |
| CatBox | approved package/tier form and labels | offer choice, deposit progression | confusing tier with deposit number |
| Furry utility icons | material/camera/light style lock | mechanics, benefits, navigation | optical weight drift |
| Furry numbers/letters | brand colors, readable glyph | promo titles, deposit counters | losing readability at mobile size |
...
- **reward inside** — what is random/guaranteed;
...
- one bridge device connects brands physically;
- do not recolor host CTA into an invented CATBET button;
...
- license entity/decision text if required;
- exact terms URL;
- permitted reward amount and presentation;
