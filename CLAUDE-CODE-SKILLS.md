...
> **Framework 2.0 notice:** цей файл зберігається як детальний історичний каталог і rationale.
> Обов'язкові repository-owned skills, cross-agent capability contracts і gate mapping тепер визначає
> [SKILLS-MANIFEST.md](SKILLS-MANIFEST.md); встановлення — [AGENT-BOOTSTRAP.md](AGENT-BOOTSTRAP.md).
