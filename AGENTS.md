...
Канонічна мова всіх human-readable документів і відповідей у проєкті — українська; винятки та
машинні ідентифікатори визначені в `LANGUAGE-POLICY.md`.
...
Будь-яке нове зображення можна читати або тимчасово використати лише в межах поточної задачі.
Перед копіюванням, завантаженням, crop/derivative або реєстрацією картинки в `brand-archive/**/assets`
обов'язково окремо запитай користувача, чи додавати **саме цей файл** як reference. Назви бренд,
джерело/файл, роль і точний target path. Без явної відповіді «так/додати» не зберігай його в framework.
